...
description: Apply when implementing features, fixing logic bugs, refactoring with behavioral impact, or updating tests. Skip for docs, minor tweaks, configs. Apply if adding branches/constraints or lacking coverage. Use for behavior changes.
---
